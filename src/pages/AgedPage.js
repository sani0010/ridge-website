    ...
    <div className="max-w-6xl mx-auto px-6 py-12">
      ...
      <div className="grid md:grid-cols-2 gap-6">
        ...
        <div className="bg-white rounded-lg shadow-lg overflow-hidden transition-all transform hover:scale-105 hover:shadow-xl duration-300">
          ...
          <div className="p-6">
            <Link to="/course/chc33021-certificate-iii-individual-support" className="text-xl font-semibold text-gray-800 hover:text-[#F26722] mb-2 transition-all duration-200">
              ICT50220 Diploma of Information Technology
            </Link>
        ...
        <div className="bg-white rounded-lg shadow-lg overflow-hidden transition-all transform hover:scale-105 hover:shadow-xl duration-300">
          ...
          <div className="p-6">
            <Link to="/course/chc43015-certificate-iv-ageing-support" className="text-xl font-semibold text-gray-800 hover:text-[#F26722] mb-2 transition-all duration-200">
              ICT60220 Advanced Diploma of Information Technology
            </Link>
