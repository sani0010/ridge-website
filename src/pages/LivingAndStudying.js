      ...
      <div className="bg-gray-100 py-12">
        <div className="container mx-auto px-4">
          <div className="bg-white rounded-lg shadow-lg p-8">
            ...
            <div className="prose text-gray-600 mx-auto">
              {activeTab === 'melbourne' ? (
                <>
                  <p>Located in the heart of Melbourne CBD, our campus provides:</p>
                  <ul className="space-y-2">
                    <li>Modern facilities and equipment</li>
                    <li>Spacious, bright classrooms</li>
                    <li>High-speed internet and computer labs</li>
                    <li>Access to public transport and parking</li>
                    <li>Comfortable and inviting study environment that is rich with resources</li>
                  </ul>
                </>
              ) : (
                <>
                  <p>Our Parramatta campus features:</p>
                  <ul className="space-y-2">
                    <li>State-of-the-art learning facilities</li>
                    <li>Modern computer laboratories</li>
                    <li>Student recreation areas</li>
                    <li>Access to public transport and parking</li>
                    <li>Modern, broadband-connected PCs, audiovisual equipment, spacious, light-filled classrooms, and a warm, resource-rich study space</li>
                  </ul>
                </>
              )}
            </div>
